  ...
  return (
    <div className="w-full max-w-md mx-auto my-20 p-4 rounded-md border border-[#73B21A] shadow-xl sm:p-8 dark:bg-gray-50 dark:text-gray-800">
      ...
      <p className="text-sm text-center dark:text-gray-600">
		...
		<button onClick={handleGoogleSignup} aria-label="Login with Google" type="button" className="cursor-pointer flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600">
